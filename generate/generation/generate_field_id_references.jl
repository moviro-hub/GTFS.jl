"""
    generate_field_id_references(extracted_references::Vector{FileForeignInfo}) -> Vector{String}
...
"""
function generate_field_id_references(extracted_references::Vector{FileForeignInfo})
    lines = String[]
    # Header
