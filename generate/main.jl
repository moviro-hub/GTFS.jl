...
function write_json_artifact(filepath::String, data::Any)
    JSON.json(filepath, data; pretty=true)
end
...
function main()
    ...
    try
        # temp dir for intermediate artifacts
        ...
        ingested_presence = RuleGenerations.Ingestion.parse_presence(lines)
        ...
        extracted_file_conditions = RuleGenerations.Extraction.extract_all_file_conditions(ingested_dataset_files, ingested_file_definitions, ingested_presence)
        ...
        extracted_field_conditions = RuleGenerations.Extraction.extract_all_field_conditions(ingested_file_definitions, ingested_presence)
        ...
        extracted_field_enum_values = RuleGenerations.Extraction.extract_all_field_enum_values(ingested_file_definitions)
        ...
        extracted_field_types = RuleGenerations.Extraction.extract_all_field_types(ingested_file_definitions, ingested_field_types, ingested_field_signs)
        ...
        extracted_field_id_references = RuleGenerations.Extraction.extract_all_field_id_references(ingested_file_definitions)
        ...
        extracted_field_constraints = RuleGenerations.Extraction.extract_all_field_constraints(ingested_file_definitions, ingested_field_signs)
        ...
        RuleGenerations.Generation.write_source_file("../src/rules/file_conditions.jl", generated_file_conditions)
        ...
        RuleGenerations.Generation.write_source_file("../src/rules/field_conditions.jl", generated_field_conditions)
        ...
        RuleGenerations.Generation.write_source_file("../src/rules/field_enum_values.jl", generated_field_enum_values)
        ...
        RuleGenerations.Generation.write_source_file("../src/rules/field_types.jl", generated_field_types)
        ...
        RuleGenerations.Generation.write_source_file("../src/rules/field_id_references.jl", generated_field_id_references)
        ...
        RuleGenerations.Generation.write_source_file("../src/rules/field_constraints.jl", generated_field_constraints)
        println("✓ Generated")
        println()
