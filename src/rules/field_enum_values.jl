...
const ENUM_RULES = Dict(
  ...
  "fare_media.txt::fare_media_type" => (
    enum_values = [
  ...
  "fare_transfer_rules.txt::duration_limit_type" => (
    enum_values = [
  ...
  "booking_rules.txt::booking_type" => (
    enum_values = [
